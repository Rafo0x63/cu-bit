$(document).ready(() => {
    ...
    const services_data = [
        { name: "Web Design", icon: "industries" },
        { name: "IT Consulting", icon: "validation" },
        { name: "Data Management", icon: "engineering" },
        { name: "IT Project Management", icon: "management" },
        { name: "Software Testing", icon: "manufacturing" },
        { name: "Cloud Services", icon: "technical" },
        { name: "Busniess Inteligence", icon: "process" }];
    ...
    const serv0 = document.querySelector(".serv-0");
    ...
    serv1.addEventListener("click", () => {
        console.log("clicked serv1");
        document.getElementById("circle-nav-copy").setAttribute("viewBox", "0 0 300 300")
    })
    serv2.addEventListener("click", () => {
        console.log("clicked serv2");
        setTimeout(() => {
            document.getElementById("circle-nav-copy").setAttribute("viewBox", "0 300 300 300")
        },2000)
